define(['pipAPI','pipScorer','underscore'], function(APIConstructor, Scorer, _) {
	...
	function stiatExtension(options)
	{
		...
		var stiatObj = 
		{
			...
			category :  
			{
				name : 'Beide', //Category name to be used for feedback and logging.
				title : {
					media : {word : 'Beide'}, //Name of the category presented in the task.
			...
			attribute1 : 
			{
				name : 'Mann', //Attribute name to be used for feedback and logging
				title : {
					media : {word : 'Mann'}, //Name of the category presented in the task.
					css : {color:'#31b404','font-size':'2em'}, //Style of the category title.
					height : 4 //Used to position the "Or" in the combined block.
				}, 
				media : [ //Stimuli
			...
			attribute2 : 
			{
				name : 'Frau', //Attribute name to be used for feedback and logging
				title : {
					media : {word : 'Frau'}, //Name of the category presented in the task.
					css : {color:'#31b404','font-size':'2em'}, //Style of the category title.
					height : 4 //Used to position the "Or" in the combined block.
				}, 
				media : [ //Stimuli
